...
class BloodRequestViewSet(PermissionMixin, viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        _create_system_notifications(
            ...
            title_key="notification.blood_request_created.title",
            message_key="notification.blood_request_created.message",
            template_params={
                "request_id": instance.id,
                "recipient_name": instance.recipient.full_name,
    ...
    def complete(self, request, pk=None):
        ...
        _create_system_notifications(
            ...
            title_key="notification.blood_request_completed.title",
            message_key="notification.blood_request_completed.message",
    ...
    def cancel(self, request, pk=None):
        ...
        _create_system_notifications(
            ...
            title_key="notification.blood_request_cancelled.title",
            message_key="notification.blood_request_cancelled.message",
            template_params={
                "request_id": blood_request.id,
                "cancelled_by": blood_request.cancelled_by,
            },
            sent_via=["in_app"],
            role_names=["admin", "receptionist"],
            request_id=blood_request.id,
    ...
    def verify(self, request, pk=None):
        ...
        _create_system_notifications(
            ...
            title_key="notification.blood_request_verified.title",
            message_key="notification.blood_request_verified.message",
            template_params={"request_id": blood_request.id},
            sent_via=["in_app"],
            role_names=["admin", "receptionist"],
            request_id=blood_request.id,
