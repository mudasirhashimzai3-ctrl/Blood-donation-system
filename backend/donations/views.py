...
class DonationViewSet(PermissionMixin, viewsets.ModelViewSet):
    ...
    def update_status(self, request, pk=None):
        ...
        _create_system_notifications(
            ...
            template_params={"donation_id": donation.id, "status": donation.status},
            sent_via=["in_app"],
    ...
    def complete(self, request, pk=None):
        ...
        _create_system_notifications(
            ...
            title_key="notification.donation_completed.title",
            message_key="notification.donation_completed.message",
            template_params={"donation_id": donation.id},
            sent_via=["in_app"],
            role_names=["admin", "receptionist"],
    ...
    def set_primary(self, request, pk=None):
        ...
        _create_system_notifications(
            ...
            title_key="notification.donation_primary_changed.title",
            message_key="notification.donation_primary_changed.message",
            template_params={
                "request_id": donation.request_id,
                "donation_id": donation.id,
                "is_primary": donation.is_primary,
            },
            sent_via=["in_app"],
            role_names=["admin", "receptionist"],
            request_id=donation.request_id,
    ...
    def send_reminder(self, request, pk=None):
        ...
        _create_system_notifications(
            ...
            title_key="notification.donation_reminder.title",
            message_key="notification.donation_reminder.message",
            template_params={"donation_id": donation.id},
            sent_via=["in_app"],
            role_names=["admin", "receptionist"],
            request_id=donation.request_id,
